...
async function problemA() {
 ...
 async function problemB() {
  ...
  // AsyncAwait version
  const poema = await promisifiedReadFile("poem-one/stanza-02.txt");
  const poema2 = await promisifiedReadFile("poem-one/stanza-03.txt");
  blue(poema);
  blue(poema2);
}
...
async function problemC() {
 ...
 async function problemD() {
  ...
  // AsyncAwait version
  try {
    const poema = await promisifiedReadFile("poem-one/stanza-04.txt");
    blue(poema)
  } catch (error) {
    magenta(error)
  }
 ...
 async function problemE() {
  ...
  // AsyncAwait version
  try {
    const poema = await promisifiedReadFile("poem-one/stanza-03.txt");
    blue(poema)
  } catch (error) {
    magenta(error)
  }
